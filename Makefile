...
AVX512FLAGS = -march=avx2 -DHAVE_SSE2 -DHAVE_AVX2
AVX512FLAGS = -march=skylake-avx512 -DHAVE_SSE2 -DHAVE_AVX2 -DHAVE_AVX512 
ARM64_NONEON_FLAGS = -DARM64_NO_NEON
ARM64_NOSHA3_FLAGS = -DARM64_NO_SHA3
NEONSHA3FLAGS = -march=armv8.3-a+sha3
...
NEON_SHA3_TARGET = $(STD_TARGET) test-neon-sha3-M19937
...
test-avx512-256-M521: test.c dSFMT.c dSFMT.h
	$(CC) $(CCFLAGS) $(AVX512FLAGS) -DDSFMT_MEXP=521 -o $@ dSFMT.c test.c

test-neon-M521: test.c dSFMT.c dSFMT.h
	$(CC) $(CCFLAGS) $(NEONFLAGS) -DDSFMT_MEXP=521 -o $@ dSFMT.c test.c

test-neon-sha3-M521: test.c dSFMT.c dSFMT.h
	$(CC) $(CCFLAGS) $(NEONSHA3FLAGS) -DDSFMT_MEXP=521 -o $@ dSFMT.c test.c
...
test-neon-sha3-M1279: test.c dSFMT.c dSFMT.h
	$(CC) $(CCFLAGS) $(NEONSHA3FLAGS) -DDSFMT_MEXP=1279 -o $@ dSFMT.c test.c
...
test-neon-sha3-M2203: test.c dSFMT.c dSFMT.h
	$(CC) $(CCFLAGS) $(NEONSHA3FLAGS) -DDSFMT_MEXP=2203 -o $@ dSFMT.c test.c
...
test-neon-sha3-M4253: test.c dSFMT.c dSFMT.h
	$(CC) $(CCFLAGS) $(NEONSHA3FLAGS) -DDSFMT_MEXP=4253 -o $@ dSFMT.c test.c
...
test-neon-sha3-M11213: test.c dSFMT.c dSFMT.h
	$(CC) $(CCFLAGS) $(NEONSHA3FLAGS) -DDSFMT_MEXP=11213 -o $@ dSFMT.c test.c
...
test-neon-sha3-M19937: test.c dSFMT.c dSFMT.h
	$(CC) $(CCFLAGS) $(NEONSHA3FLAGS) -DDSFMT_MEXP=19937 -o $@ dSFMT.c test.c
...
test-neon-sha3-M44497: test.c dSFMT.c dSFMT.h
	$(CC) $(CCFLAGS) $(NEONSHA3FLAGS) -DDSFMT_MEXP=44497 -o $@ dSFMT.c test.c
...
test-neon-sha3-M86243: test.c dSFMT.c dSFMT.h
	$(CC) $(CCFLAGS) $(NEONSHA3FLAGS) -DDSFMT_MEXP=86243 -o $@ dSFMT.c test.c
...
test-neon-sha3-M132049: test.c dSFMT.c dSFMT.h
	$(CC) $(CCFLAGS) $(NEONSHA3FLAGS) -DDSFMT_MEXP=132049 -o $@ dSFMT.c test.c
...
test-neon-sha3-M216091: test.c dSFMT.c dSFMT.h
	$(CC) $(CCFLAGS) $(NEONSHA3FLAGS) -DDSFMT_MEXP=216091 -o $@ dSFMT.c test.c
.c.o:
	$(CC) $(CCFLAGS) -c $<
