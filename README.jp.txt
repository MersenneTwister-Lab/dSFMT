 ...
 Masaki Ota adapted the dSFMT code to support AVX2, AVX512, and ARM64 NEON.
 ...
 このバージョンはMasaki OtaさんがdSFMTをAVX2, AVX512, ARM64 NEON
 に対応させてくださったものです。実験的なバージョンとしてexperimentalブランチに置きます。

 Qiita に Masaki Ota さんによる記事があります。
 https://qiita.com/STDNUL/items/8d7e0d1919847196b45d
